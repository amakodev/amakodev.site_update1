        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="h-8 mb-6">
              <span className="text-xl text-blue-400">{typedText}<span className="animate-pulse">|</span></span>
            </div>
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <motion.button 
                onClick={() => onNavigate(3)} // Navigate to Projects section
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white font-semibold rounded-lg transition duration-300 shadow-lg shadow-blue-500/20"
              ...
              <motion.button
                onClick={() => onNavigate(1)} // Navigate to Experience section
                className="px-6 py-3 border border-blue-600 text-blue-500 hover:bg-blue-900/20 font-semibold rounded-lg transition duration-300"
          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              ...
              {/* Floating badge */}
              <motion.div 
                className="absolute bottom-6 left-6 bg-gradient-to-r from-blue-600/90 to-violet-600/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg z-20"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-white">Ready for new projects</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
